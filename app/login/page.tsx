  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-10 w-full max-w-sm text-center">
        ...
        <h1 className="text-2xl font-semibold text-gray-900 mb-1">AI Energy Chat</h1>
        <p className="text-sm text-gray-500 mb-8">
          Chat with AI. See your energy footprint.
        </p>
        <button
        ...
        <p className="text-xs text-gray-400 mt-6">
          Research platform · Not a production product
        </p>
      </div>
    </div>
  );
